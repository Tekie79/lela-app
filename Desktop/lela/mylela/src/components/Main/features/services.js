      ...
      <div className="home_features">
        <div className="home_feature-services">
          ...
          <p>
            ...
            hand-waving or jargon, just practical solutions with real results.
          </p>
        </div>
        <div className="home_feature-services">
          ...
          <p>
            ...
            your requirements and turn them into reality, with a focus on
            productivity to make things work better over time.
          </p>
        </div>
      </div>
    </div>
